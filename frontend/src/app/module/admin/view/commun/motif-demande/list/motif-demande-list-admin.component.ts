...
@Component({
  selector: 'app-motif-demande-list-admin',
  standalone: false,
  templateUrl: './motif-demande-list-admin.component.html'
})
export class MotifDemandeListAdminComponent implements OnInit {

    protected fileName = 'MotifDemande';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MotifDemandeDto>();
    ...
    public async edit(dto: MotifDemandeDto) {
    ...
    public async view(dto: MotifDemandeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MotifDemandeDto) {
    ...
    public async duplicate(dto: MotifDemandeDto) {
    ...
    public exportPdf(dto: MotifDemandeDto): void {
...
// add
	...
	public initDuplicate(res: MotifDemandeDto) {
	}
    ...
    get selections(): Array<MotifDemandeDto> {
        return this.service.selections;
    }

    set selections(value: Array<MotifDemandeDto>) {
