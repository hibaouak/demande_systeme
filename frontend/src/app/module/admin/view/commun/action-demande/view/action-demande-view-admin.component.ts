...
@Component({
  selector: 'app-action-demande-view-admin',
  standalone: false,
  templateUrl: './action-demande-view-admin.component.html'
})
export class ActionDemandeViewAdminComponent implements OnInit {
    ...
    constructor(private service: ActionDemandeAdminService){
