...
@Component({
  selector: 'app-action-demande-list-admin',
  standalone: false,
  templateUrl: './action-demande-list-admin.component.html'
})
export class ActionDemandeListAdminComponent implements OnInit {

    protected fileName = 'ActionDemande';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ActionDemandeDto>();
    ...
    public async edit(dto: ActionDemandeDto) {
    ...
    public async view(dto: ActionDemandeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ActionDemandeDto) {
    ...
    public async duplicate(dto: ActionDemandeDto) {
    ...
    public exportPdf(dto: ActionDemandeDto): void {
...
// add
	...
	public initDuplicate(res: ActionDemandeDto) {
	}
    ...
    get selections(): Array<ActionDemandeDto> {
        return this.service.selections;
    }

    set selections(value: Array<ActionDemandeDto>) {
