...
export class DemandeEditAdminComponent implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateAffectation = this.service.format(this.item.dateAffectation);
        this.item.dateAnnulation = this.service.format(this.item.dateAnnulation);
        this.item.dateCloture = this.service.format(this.item.dateCloture);
