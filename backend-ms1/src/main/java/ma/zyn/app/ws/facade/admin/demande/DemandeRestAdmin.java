...
public class DemandeRestAdmin {
    ...
    @Operation(summary = "Finds a demande by numero")
    @GetMapping("numero/{numero}")
    public ResponseEntity<DemandeDto> findByNumero(@PathVariable String numero) {
	    Demande t = service.findByReferenceEntity(new Demande(numero));
        if (t != null) {
            converter.init(true);
            DemandeDto dto = converter.toDto(t);
            return getDtoResponseEntity(dto);
